...
use AssistantEngine\Filament\Contracts\ContextModelInterface;
...
class ContextResolver implements ContextResolverInterface
{
    ...
    public function resolveModels($className, array $models): array
    {
        $result = [];
        ...
        $this->collectRelatedModels($result, $className, $models);
